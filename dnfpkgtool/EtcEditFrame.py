...
class EtcframeWidget(ttk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.goldDropTreeV.configure(height=6, selectmode="extended", show="headings")
        ...
        self.goldDropTreeV.configure(
            columns=self.goldDropTreeV_cols, displaycolumns=self.goldDropTreeV_dcols
        )
        self.goldDropTreeV.column(
            "column1", anchor="center", stretch="true", width=40, minwidth=20
        )
        self.goldDropTreeV.column(
            "column2", anchor="center", stretch="true", width=80, minwidth=20
        )
        self.goldDropTreeV.column(
            "column3", anchor="center", stretch="true", width=50, minwidth=20
        )
        ...
        label10.configure(background="#808080", foreground="#ffffff", text="普通")
        label10.grid(column=0, row=1)
        label11 = ttk.Label(self.labelframe3)
        label11.configure(background="#0080ff", foreground="#ffffff", text="高级")
        label11.grid(column=0, row=2)
        label12 = ttk.Label(self.labelframe3)
        label12.configure(background="#8000ff", foreground="#ffffff", text="稀有")
        label12.grid(column=0, row=3)
        label13 = ttk.Label(self.labelframe3)
        label13.configure(background="#ff80ff", foreground="#ffffff", text="神器")
        label13.grid(column=0, row=4)
        label14 = ttk.Label(self.labelframe3)
        label14.configure(background="#ff8000", foreground="#ffffff", text="史诗")
        ...
        label19.configure(background="#808080", foreground="#ffffff", text="普通")
        label19.grid(column=0, row=1)
        label20 = ttk.Label(self.labelframe1)
        label20.configure(background="#0080ff", foreground="#ffffff", text="高级")
        label20.grid(column=0, row=2)
        label21 = ttk.Label(self.labelframe1)
        label21.configure(background="#8000ff", foreground="#ffffff", text="稀有")
        label21.grid(column=0, row=3)
        label22 = ttk.Label(self.labelframe1)
        label22.configure(background="#ff80ff", foreground="#ffffff", text="神器")
        label22.grid(column=0, row=4)
        label23 = ttk.Label(self.labelframe1)
        label23.configure(background="#ff8000", foreground="#ffffff", text="史诗")
    ...
    def on_PVF_load(self):
        ...
        def get_independDrop_files():
            ...
            for filePath in self.pvf.fileTreeDict.keys():
                if (
                    filePath[:19] == "etc/independentdrop"
                    and len(filePath.split("/")) > 2
                ):
    ...
    def show_json(self, e):
        def func():
            ...
            jsonString = json.dumps(
                leaf["itemInDict"], sort_keys=True, indent=4, separators=(",", ":")
            )
