...
class GuiApp:
    def __init__(self, master=None, check_update=True, style=None):
        ...
        frame27.configure(height=90, width=200)
    ...
    def _build(self):
        ...
        self.blobFrameList = [
            ...
            self.creatureFrame,
            self.cargoFrame,
            self.accountCargoFrame,
        ]

        self.nonBlobFrameList = [
        ...
        self.mailFrame = mail_frame.MailFrameWidget(self.mailFrame)
        ...
        for tree in list(self.itemsTreevs_now.values()) + [
            self.characTreeV,
            self.banedTreeV,
        ]:
        ...
        boxs = [
            self.characTreeV,
            self.creatureItemFrame.itemsTreev_now,
            self.avatarFrame.itemsTreev_now,
            self.mailFrame.itemsTreev_now,
            self.banedTreeV,
        ]
        bars = [
            self.characBar,
            self.creatureItemFrame.itemsTreev_bar,
            self.avatarFrame.itemsTreev_bar,
            self.mailFrame.itemsTreev_bar,
            self.banedBar,
        ]
    ...
    def _buildtab_main(self):
        ...
        @in_thread
        def selectCharac(showTitle=False) -> None:
    ...
    def _buildtab_itemTab(
        ...
        def delete_all_item() -> None:
            ...
            sqlM.commit_change_blob(
                self.globalCharacBlobs[tabName],
                editedDict,
                self.cNo,
        ...
        def showSelectedItemInfo(save=True, reset=False) -> bool:
        ...
        magicSealEntrys = [
            ...
            itemEditFrame.magicSealEntry1,
            itemEditFrame.magicSealEntry2,
            itemEditFrame.magicSealEntry3,
        ]
        magicSealIDEntrys = [
            itemEditFrame.magicSealIDEntry,
            itemEditFrame.magicSealIDEntry1,
            itemEditFrame.magicSealIDEntry2,
            itemEditFrame.magicSealIDEntry3,
        ]
        magicSealLevelEntrys = [
            itemEditFrame.magicSealLevelEntry,
            itemEditFrame.magicSealLevelEntry1,
            itemEditFrame.magicSealLevelEntry2,
            itemEditFrame.magicSealLevelEntry3,
        ]
        ...
        def connect(show=True, key=False):
            def inner():
                ...
                if key:
                    ...
                    try:
                        ssh.connect(
                            ip, username=user, port=port, pkey=private_key, timeout=3
                        )
                    ...
                    try:
                        ssh.connect(
                            ip, username=user, port=port, password=pwd, timeout=3
                        )
                        self.transPort = paramiko.Transport((ip, port))
