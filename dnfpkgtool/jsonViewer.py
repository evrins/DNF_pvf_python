...
def json_tree(tree: ttk.Treeview, parent, dictionary, depth=-1):
    ...
    for key in dictionary:
        ...
        if isinstance(dictionary[key], dict):
            ...
            try:
                tree.insert(
                    parent, 'end', uid, text=str(key), value=[value], tags='value'
                )
            except:
                tree.insert(
                    parent, 'end', uid, text=str(key), value=['ERROR'], tags='value'
                )
...
if __name__ == '__main__':
    d = {'123213': {123: 'asdasd'}, 123333: {'ddddd': 111}, 'list': [1, 2, 3, 4, 5]}
    show_data(d)
