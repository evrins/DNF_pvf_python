...
class CharacterFrameWidget(ttk.Frame):
    def __init__(self, master=None, **kw):
        super(CharacterFrameWidget, self).__init__(master, **kw)
        ...
        self.saveStartBtn.configure(command=self.save_start)
        ...
        self.growTypeE.grid(column=1, columnspan=2, padx=1, pady=1, row=3, sticky="ew")
        ...
        self.characEntriesFrame.pack(
            anchor="center", expand=True, fill="both", padx=5, pady=5, side="top"
        )
...
if __name__ == "__main__":
    root = tk.Tk()
    widget = CharacterFrameWidget(root)
