...
class MailFrameWidget(tk.Frame):
    def __init__(self, master=None, **kw):
        super(MailFrameWidget, self).__init__(master, **kw)
        ...
        self.itemsTreev_now.column(
            'column1', anchor='center', stretch=True, width=20, minwidth=20
        )
        self.itemsTreev_now.column(
            'column2', anchor='center', stretch=True, width=60, minwidth=20
        )
        self.itemsTreev_now.column(
            'column4', anchor='center', stretch=True, width=50, minwidth=20
        )
        self.itemsTreev_now.column(
            'column5', anchor='center', stretch=True, width=40, minwidth=20
        )
        self.itemsTreev_now.column(
            'column6', anchor='center', stretch=True, width=40, minwidth=20
        )
        self.itemsTreev_now.column(
            'column3', anchor='center', stretch=True, width=30, minwidth=20
        )

        self.itemsTreev_now.heading('column1', anchor='center', text=' ')
        self.itemsTreev_now.heading('column2', anchor='center', text='物品名')
        self.itemsTreev_now.heading('column4', anchor='center', text='物品ID')
        self.itemsTreev_now.heading('column5', anchor='center', text='发件人')
        self.itemsTreev_now.heading('column6', anchor='center', text='数量')
        self.itemsTreev_now.heading('column3', anchor='center', text='类型')
