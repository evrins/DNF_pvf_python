...
class ItemslotframeWidget(tk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.inv_capacityE.configure(state="readonly", values="0 8 16", width=4)
        self.inv_capacityE.pack(side="left")
        self.inv_capacityE.bind("<<ComboboxSelected>>", self.set_inv_capacity, add="")
        ...
        self.itemsTreev_now.column(
            "column5", anchor="center", stretch=True, width=60, minwidth=20
        )
        self.itemsTreev_now.column(
        ...
        self.itemNameEntry.grid(column=1, columnspan=2, pady=1, row=0, sticky="ew")
        self.itemNameEntry.bind("<<ComboboxSelected>>", self.readSlotName, add="")
        ...
        self.itemIDEntry.grid(column=1, columnspan=1, pady=1, row=1, sticky="ew")
        ...
        self.enableTypeBtn.grid(column=0, columnspan=2, padx=3, row=6, sticky="w")
        ...
        self.typeEntry.bind("<<ComboboxSelected>>", self.changeItemSlotType, add="")
        ...
        self.orbTypeEntry.bind("<<ComboboxSelected>>", self.setOrbTypeCom, add="")
        ...
        self.orbValueEntry.bind("<<ComboboxSelected>>", self.setOrbValueCom, add="")
        ...
        self.magicSealEntry.bind("<<ComboboxSelected>>", self.setMagicSeal, add="")
        ...
        self.magicSealEntry1.bind("<<ComboboxSelected>>", self.setMagicSeal, add="")
        ...
        self.magicSealEntry2.bind("<<ComboboxSelected>>", self.setMagicSeal, add="")
        ...
        self.magicSealEntry3.bind("<<ComboboxSelected>>", self.setMagicSeal, add="")
