...
class Ui_inventory_equipment_form(object):
    def setupUi(self, inventory_equipment_form):
        ...
        sizePolicy.setHeightForWidth(self.seal_count_spin_box.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHeightForWidth(self.grade_spin_box.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.ms_1_container.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.ms_2_container.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, inventory_equipment_form):
        ...
        self.grade_label.setText(QCoreApplication.translate("inventory_equipment_form", u"\u7b49\u7ea7", None))
