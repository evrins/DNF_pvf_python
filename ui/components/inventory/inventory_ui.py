...
class Ui_inventory_container(object):
    def setupUi(self, inventory_container):
        if not inventory_container.objectName():
            inventory_container.setObjectName('inventory_container')
        ...
        self.table_view_container.setObjectName('table_view_container')
        ...
        self.show_blank_chkbox.setObjectName('show_blank_chkbox')
        ...
        self.items_table_view.setEditTriggers(
            QAbstractItemView.EditTrigger.NoEditTriggers
        )
        self.items_table_view.setSelectionMode(
            QAbstractItemView.SelectionMode.SingleSelection
        )
        self.items_table_view.setSelectionBehavior(
        ...
        self.form_stack_widget.setObjectName('form_stack_widget')

        self.verticalLayout_2.addWidget(self.form_stack_widget)

        self.horizontalLayout.addWidget(
            self.item_edit, 0, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop
        )
    ...
    def retranslateUi(self, inventory_container):
        inventory_container.setWindowTitle(
            QCoreApplication.translate('inventory_container', 'Form', None)
        )
        self.table_view_container.setTitle(
            QCoreApplication.translate('inventory_container', 'Current Items', None)
        )
        self.show_blank_chkbox.setText(
            QCoreApplication.translate('inventory_container', 'Show Blank', None)
        )
        self.item_edit.setTitle(
            QCoreApplication.translate('inventory_container', 'Item Edit', None)
        )
